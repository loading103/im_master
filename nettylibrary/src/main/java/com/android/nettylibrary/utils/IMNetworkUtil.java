...
public class IMNetworkUtil {
    ...
    public static boolean isConnected() {
        Context context = IMSNettyManager.getInstance().getContext();
    ...
    public static boolean isWifiConnected() {
        ...
        try {
            ConnectivityManager cm = (ConnectivityManager)  IMSNettyManager.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
