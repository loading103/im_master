package com.android.nettylibrary.interfac;
...
public interface IMSClientInterface {
     ...
     * @param msg
     */
    void sendMsg(MessageProtobuf.ImMessage msg);
     ...
     */
    void sendMsg(MessageProtobuf.ImMessage msg, boolean isJoinTimeoutManager);
     ...
     * @return
     */
    MessageProtobuf.ImMessage getHandshakeMsg();
     ...
     * @return
     */
    MessageProtobuf.ImMessage getHeartbeatMsg();
