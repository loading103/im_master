...
public class NewBesselImageView extends ImageView {
    ...
    public NewBesselImageView(Context context) {
        this(context, null);
    }

    public NewBesselImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewBesselImageView(Context context, AttributeSet attrs, int defStyleAttr) {
