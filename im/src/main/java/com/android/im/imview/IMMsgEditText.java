...
public class IMMsgEditText extends AppCompatEditText {


    public IMMsgEditText(Context context) {
        super(context);
    }

    public IMMsgEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IMMsgEditText(Context context, AttributeSet attrs, int defStyleAttr) {
