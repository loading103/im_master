package com.android.im.imview.butterview;
...
public class IMCacheImageView extends ImageView {

	protected ImageLoader imageLoader;
	protected DisplayImageOptions options;
	protected AnimateFirstDisplayListener firstListener;
	protected DisplayImageOptions.Builder builder;
	public IMCacheImageView(Context context) {
		super(context);
		initCache();
	}

	public IMCacheImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCache();
	}

	public IMCacheImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void load(final String url, DisplayImageOptions options,
		...
		imageLoader.displayImage(url, IMCacheImageView.this, options,
