...
public class IMEmojiLayoutView1 extends LinearLayout implements View.OnClickListener, IEmotionSelectedListener {
    ...
    public IMEmojiLayoutView1(Context context) {
        this(context,null);
    }

    public IMEmojiLayoutView1(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public IMEmojiLayoutView1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        LayoutInflater.from(mcontext).inflate(R.layout.layout_im_emoji1,this);
        ...
        if(isgroup){
            mLlContain.setVisibility(VISIBLE);
        }else {
