...
public class IMSeparatedEditText extends AppCompatEditText {
    ...
    public IMSeparatedEditText(Context context) {
        this(context, null);
    }

    public IMSeparatedEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IMSeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        password = ta.getBoolean(R.styleable.SeparatedEditText_password, true);
        ...
        borderWidth = (int) ta.getDimension(R.styleable.SeparatedEditText_borderWidth, 2);
