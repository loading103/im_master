...
// */
//
//public class IMCustomShapeTransformation extends BitmapTransformation {
//
//    private Paint mPaint; // 画笔
//    private Context mContext;
//    private int mShapeRes; // 形状的drawable资源
//
//    public IMCustomShapeTransformation(Context context, int shapeRes) {
//        super(context);
//        mContext = context;
//        mShapeRes = shapeRes;
...
//    public String getId() {
//        // 用于缓存的唯一标识符
//        return "IMCustomShapeTransformation" + mShapeRes;
//    }
//
//    // 获取屏幕的宽度
