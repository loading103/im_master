...
public class IMHeadZoomScrollView extends ScrollView {
    ...
    public IMHeadZoomScrollView(Context context) {
        super(context);
    }

    public IMHeadZoomScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IMHeadZoomScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
