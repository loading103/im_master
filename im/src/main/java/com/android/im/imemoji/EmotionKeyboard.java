package com.android.im.imemoji;
...
public class EmotionKeyboard {
    ...
    private void showEmotionLayout() {
        ...
        if (softInputHeight == 0) {
            softInputHeight = Integer.parseInt(IMPreferenceUtil.getPreference_String(SHARE_PREFERENCE_SOFT_INPUT_HEIGHT, dip2Px(270) + ""));
        }
        IMLogUtil.d("MyOwnTag:", "EmotionKeyboardsoftInputHeight22====-"+softInputHeight);
        if(softInputHeight<dip2Px(180)){
    ...
    public boolean isSoftInputShown() {
        ...
        boolean isKeyboardShowing = r.bottom < IMDensityUtil.getScreenHeight(IMSManager.getInstance().getContext());
    ...
    private int getSupportSoftInputHeight() {
        ...
        //存一份到本地
        if (softInputHeight > 0) {
            int anInt = Integer.parseInt(IMPreferenceUtil.getPreference_String(SHARE_PREFERENCE_SOFT_INPUT_HEIGHT,"0"));
            if(softInputHeight>anInt){
                IMPreferenceUtil.getPreference_String(SHARE_PREFERENCE_SOFT_INPUT_HEIGHT,softInputHeight+"");
            }
        }
    ...
    public int getKeyBoardHeight() {
        return Integer.parseInt(IMPreferenceUtil.getPreference_String(SHARE_PREFERENCE_SOFT_INPUT_HEIGHT,"400"));
    }
}
