...
public class EmotionLayout extends LinearLayout implements View.OnClickListener {
    ...
    private boolean mEmotionAddVisiable = true;
    private boolean mEmotionSettingVisiable = true;
    ...
    private void init() {
        ...
        inflater.inflate(R.layout.emotion_im_layout, this);
//        View.inflate(mContext, R.layout.emotion_im_layout, this);
    ...
    private void initTabs() {
        //默认添加一个表情tab
        EmotionTab emojiTab = new EmotionTab(mContext, R.drawable.im_ic_tab_emoji);
        ...
        //最后添加一个表情设置Tab
        mSettingTab = new EmotionTab(mContext, R.drawable.im_ic_emotion_setting);
    ...
    private void selectTab(int tabPosi) {
        ...
        for (int i = 0; i < mTabCount; i++) {
            try {
                ...
                tab.setBackgroundResource(R.drawable.im_shape_tab_normal);
            }catch (Exception e){

            }
        }
        mTabViewArray.get(tabPosi).setBackgroundResource(R.drawable.im_shape_tab_press);
        ...
        for (int i = 0; i < forMax; i++) {
            if (pageCount <= hasCount) {
                ...
                if (i < hasCount) {
                    ...
                    ivCur.setBackgroundResource(R.drawable.im_selector_view_pager_indicator);
