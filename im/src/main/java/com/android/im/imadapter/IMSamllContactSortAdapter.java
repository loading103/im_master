 ...
 */ 
public class IMSamllContactSortAdapter extends BaseAdapter implements SectionIndexer {
	private List<IMPersonBean> list = null;
	private Context mContext;

	public IMSamllContactSortAdapter(Context mContext, List<IMPersonBean> list) {
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.contact_list_item_01, null);
