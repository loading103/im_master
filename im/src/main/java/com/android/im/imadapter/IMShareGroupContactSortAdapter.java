 ...
 */
public class IMShareGroupContactSortAdapter extends BaseAdapter implements SectionIndexer {
	private List<IMGroupBean> list = null;
	private Context mContext;

	public IMShareGroupContactSortAdapter(Context mContext, List<IMGroupBean> list) {
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_share_group_item,null);
