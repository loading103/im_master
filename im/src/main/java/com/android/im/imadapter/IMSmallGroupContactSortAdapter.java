 ...
 */
public class IMSmallGroupContactSortAdapter extends BaseAdapter implements SectionIndexer {
	private List<IMGroupBean> list = null;
	private Context mContext;

	public IMSmallGroupContactSortAdapter(Context mContext, List<IMGroupBean> list) {
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_share_list_item, null);
		...
		holder.line2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(ischoosed){
					finalHolder.cb_choosed.setChecked(false);
				}else {
					finalHolder.cb_choosed.setChecked(true);
				}
