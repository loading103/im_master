 ...
 */ 
public class IMCreatGroupAdapter extends BaseAdapter implements SectionIndexer {
	private List<IMPersonBean> list = null;
	private Context mContext;

	public IMCreatGroupAdapter(Context mContext, List<IMPersonBean> list) {
	...
	public List<IMPersonBean> getChoosedList() {
		List<IMPersonBean> data=new ArrayList<>();
