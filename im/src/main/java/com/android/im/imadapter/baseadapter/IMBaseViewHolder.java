 ...
 */
package com.android.im.imadapter.baseadapter;
...
public class IMBaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageView setImageLoader(int id, String imgPath) {
        ImageView img= (ImageView) convertView.findViewById(id);
        IMImageLoadUtil.ImageCharLoad(context,imgPath,img);
        return img;
     ...
     * 圆角图片
     */
    public ImageView setRoundImageLoader(int id, String imgPath) {
        ImageView img= (ImageView) convertView.findViewById(id);
        IMImageLoadUtil.ImageLoadRound(context,imgPath,img);
        return img;
    }
    /**
     * 圆行图片
     */
    public ImageView setCircleImageLoader(int id, String imgPath) {
        ImageView img= (ImageView) convertView.findViewById(id);
        IMImageLoadUtil.ImageLoadCircle(context,imgPath,img);
        return img;
    }
