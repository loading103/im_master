 ...
 * 投注记录（状态）
 */
public class IMPopWindowTypeAdapter extends IMBaseRecycleViewAdapter_T<IMGameTypeBean> {

    private Context context;

    private List<IMGameTypeBean> datas = new ArrayList<>();


    public IMPopWindowTypeAdapter(Context context, int layoutId, List<IMGameTypeBean> datas) {
    ...
    @Override
    protected void convert(IMBaseViewHolder holder, final int position, IMGameTypeBean bean) {
